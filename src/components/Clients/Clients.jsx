      ...
      <div className="container_fifth">
        ...
        <div className="carousel_container">
          <div className="carousel_content">
            ...
            />
            <p className="carousel_para">{clients[currentClient].description}</p>
            <h6 className="carousel_head">{clients[currentClient].name}</h6>
            <p className="carousel_position">
              Job position <span className="span_text">{clients[currentClient].position}</span>
            </p>
          </div>
          ...
          <div className="carousel_lines">
            {clients.map((client, index) => (
              <div
                key={index}
                className={`carousel_line ${index === currentClient ? 'active' : ''}`}
